...
class ZpatFilter2011 : public edm::EDFilter, public SelectionUtils {
	public:
		explicit ZpatFilter2011(const edm::ParameterSet &);
		~ZpatFilter2011();
...
//
ZpatFilter2011::ZpatFilter2011 (const edm::ParameterSet & parameters)
{
