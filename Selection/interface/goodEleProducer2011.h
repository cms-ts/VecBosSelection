#ifndef goodEleProducer2011_h_
#define goodEleProducer2011_h_
...
class goodEleProducer2011 : public edm::EDProducer, public SelectionUtils {
	public:
		explicit goodEleProducer2011(const edm::ParameterSet &);
		~goodEleProducer2011();
...
//
goodEleProducer2011::goodEleProducer2011 (const edm::ParameterSet & parameters)
{
   Debug2 = false;
   passSelection=true;
...
goodEleProducer2011::~goodEleProducer2011 ()
{
