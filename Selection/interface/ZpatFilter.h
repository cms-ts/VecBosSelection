...
class ZpatFilter : public edm::EDFilter, public SelectionUtils {
	public:
		explicit ZpatFilter(const edm::ParameterSet &);
		~ZpatFilter();
...
//
ZpatFilter::ZpatFilter (const edm::ParameterSet & parameters)
{
